...
file delete -force ../PtGlobal/${top_design}
set multi_scenario_working_directory ../PtGlobal/${top_design}
set multi_scenario_merged_error_log ../PtGlobal/${top_design}/error_log.txt
